...
class AppColors {
  ...
  static const Color secondaryBackground = Color.fromARGB(255, 19, 52, 91);
  static const Color ternaryBackground = Color.fromARGB(255, 151, 247, 46);
  static const Color primaryElement = Color.fromARGB(255, 255, 255, 255);
  static const Color secondaryElement = Color.fromARGB(255, 19, 52, 91);
  ...
  static const Color accentText = Color.fromARGB(255, 117, 123, 126);
}