/*
*  add_lot_details_tab_widget.dart
*  OWNERP$U
*
...
class AddLotDetailsTabWidget extends StatelessWidget {
  
  void onNextButtonPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => AddLotSpacesWidget()));
