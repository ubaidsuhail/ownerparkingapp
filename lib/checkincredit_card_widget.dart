/*
*  checkincredit_card_widget.dart
*  OWNERP$U
*
...
import 'package:p4u/checkoutccwidget.dart';
import 'package:p4u/values.dart';


class CHECKINCreditCardWidget extends StatelessWidget {
  
  //void onCheckInPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => CHECKOUTCCWidget()));
                      ...
                      Container(
                          ...
                          child: FlatButton(
                              onPressed: () {
                                ...
                                Navigator.push(context, MaterialPageRoute(builder: (context) => CHECKOUTCCWidget()));
