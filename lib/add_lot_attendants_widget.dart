...
class AddLotAttendantsWidget extends StatefulWidget {
  @override
  _AddLotAttendantScreenState createState() => _AddLotAttendantScreenState();
}

class _AddLotAttendantScreenState extends State<AddLotAttendantsWidget> {
  @override
      ...
      child: Column(
        children: [
          ...
          Align(
            ...
            child: GestureDetector(
              onTap: (){
                showToast("ALL DONE", gravity: Toast.BOTTOM,duration: Toast.LENGTH_LONG);
              },
              child: Container(
                decoration: BoxDecoration(
