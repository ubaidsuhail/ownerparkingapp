/*
*  edit_lot_attendants_widget.dart
*  OWNERP$U
*
...
import 'package:p4u/editaddatendantwidget.dart';
import 'package:p4u/home_widget.dart';
import 'package:p4u/values.dart';


class EditLotAttendantsWidget extends StatelessWidget {
  
  void onSaveButtonPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => HomeWidget()));
  
  void onAddAnotherPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => EDITADDATENDANTWidget()));
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    margin: EdgeInsets.only(left: 51, top: 39, right: 52),
                    child: Text(
                      "ASSIGNED ATTENDANTS TO THIS LOT",
                  ...
                  Align(
                    ...
                    child: Container(
                      width: 156,
                      height: 22,
                      margin: EdgeInsets.only(top: 54, right: 108),
                      child: FlatButton(
