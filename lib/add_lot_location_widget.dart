...
class AddLotLocationWidget extends StatefulWidget {
  @override
  _AddLotLocationScreenState createState() => _AddLotLocationScreenState();
}

class _AddLotLocationScreenState extends State<AddLotLocationWidget> {
  @override
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            GestureDetector(
              onTap: (){
                showToast("Location Saved Last step add guard", gravity: Toast.BOTTOM,duration: Toast.LENGTH_LONG);
              },
              child: Container(
                decoration: BoxDecoration(
