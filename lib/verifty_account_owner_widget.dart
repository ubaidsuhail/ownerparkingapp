/*
*  verifty_account_owner_widget.dart
*  OWNERP$U
*
...
class VeriftyAccountOwnerWidget extends StatelessWidget {
  
  void onDonePressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => LoginOwnerWidget()));
