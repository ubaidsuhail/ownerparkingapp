...
class LoginOwnerWidget extends StatelessWidget {
  ...
  //void onDonTHaveAnAccounPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => RegisterOwnerWidget()));
                          ...
                          Column(
                            children: <Widget>[
                              Container(
                                ...
                                child: FlatButton(
                                  onPressed: () {
                                    Navigator.push(context, MaterialPageRoute(builder: (context) => MenuOwnerWidget()));
                                  },
