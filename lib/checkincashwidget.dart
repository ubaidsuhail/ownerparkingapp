...
import 'package:p4u/checkoutcashwidget.dart';
import 'package:p4u/values.dart';


class CHECKINCASHWidget extends StatelessWidget {
  
  //void onCheckInPressed(BuildContext context) => Navigator.push(context, MaterialPageRoute(builder: (context) => CHECKOUTCASHWidget()));
